...
\datastatement
The code needed to reproduce or build on this work is online at https://brohan.org/ML\_monthly\_UK. The repository includes tools to download the data required. 
